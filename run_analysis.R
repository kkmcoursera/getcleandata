...
# Write tidy data frame to a text output file, in the original folder as the input
...
# Write results to a text output file, in the original folder as the input
